      ...
      <div>
        <div className="container-fluid">
          ...
          <div className="col-12 form-group">
            ...
            <input type="text" className="form-control mt-2" id="licence" />
          </div>
          ...
          <div className="col-12 mt-3 text-center">
            <a href="./company.register.html">返回至企业登录</a>
            <br />
            <br />
            <a href="./login.html">切换至用户登录</a>
          </div>
        </div>
...
ReactDOM.render(<CompanyRegister />, document.getElementById('app'))
